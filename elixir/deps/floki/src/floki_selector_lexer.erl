-file("/usr/local/Cellar/erlang/23.0.3/lib/erlang/lib/parsetools-2.2/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/23.0.3/lib/erlang/lib/parsetools-2.2/include/leexinc.hrl", 14).
...
yystate(54, [94|Ics], Line, Tlen, Action, Alen) ->
...
yystate(54, [63|Ics], Line, Tlen, Action, Alen) ->
    yystate(56, Ics, Line, Tlen+1, Action, Alen);
yystate(54, [64|Ics], Line, Tlen, Action, Alen) ->
    yystate(56, Ics, Line, Tlen+1, Action, Alen);
...
yystate(54, [37|Ics], Line, Tlen, Action, Alen) ->
    yystate(56, Ics, Line, Tlen+1, Action, Alen);
yystate(54, [38|Ics], Line, Tlen, Action, Alen) ->
    yystate(56, Ics, Line, Tlen+1, Action, Alen);
...
yystate(54, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(54, [C|Ics], Line, Tlen, Action, Alen) when C >= 127 ->
    yystate(56, Ics, Line, Tlen+1, Action, Alen);
...
yystate(52, [62|Ics], Line, Tlen, _, _) ->
...
yystate(52, [41|Ics], Line, Tlen, _, _) ->
    yystate(48, Ics, Line, Tlen+1, 24, Tlen);
...
yystate(44, [12|Ics], Line, Tlen, _, _) ->
    yystate(44, Ics, Line, Tlen+1, 21, Tlen);
yystate(44, [13|Ics], Line, Tlen, _, _) ->
    yystate(44, Ics, Line, Tlen+1, 21, Tlen);
yystate(44, [9|Ics], Line, Tlen, _, _) ->
    yystate(44, Ics, Line, Tlen+1, 21, Tlen);
yystate(44, [10|Ics], Line, Tlen, _, _) ->
    yystate(44, Ics, Line+1, Tlen+1, 21, Tlen);
...
yystate(42, Ics, Line, Tlen, _, _) ->
    {22,Tlen,Ics,Line,42};
yystate(41, [41|Ics], Line, Tlen, Action, Alen) ->
...
yystate(40, [10|Ics], Line, Tlen, _, _) ->
    yystate(40, Ics, Line+1, Tlen+1, 19, Tlen);
...
yystate(38, Ics, Line, Tlen, _, _) ->
    {23,Tlen,Ics,Line,38};
yystate(37, [100|Ics], Line, Tlen, Action, Alen) ->
    yystate(41, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [68|Ics], Line, Tlen, Action, Alen) ->
    yystate(41, Ics, Line, Tlen+1, Action, Alen);
...
yystate(36, [10|Ics], Line, Tlen, _, _) ->
    yystate(36, Ics, Line+1, Tlen+1, 20, Tlen);
yystate(36, Ics, Line, Tlen, _, _) ->
    {20,Tlen,Ics,Line,36};
yystate(35, [118|Ics], Line, Tlen, Action, Alen) ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(35, [86|Ics], Line, Tlen, Action, Alen) ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
...
yystate(29, [79|Ics], Line, Tlen, _, _) ->
    yystate(33, Ics, Line, Tlen+1, 25, Tlen);
yystate(29, [78|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line, Tlen+1, 25, Tlen);
...
yystate(23, [110|Ics], Line, Tlen, Action, Alen) ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
yystate(23, [78|Ics], Line, Tlen, Action, Alen) ->
    yystate(39, Ics, Line, Tlen+1, Action, Alen);
...
yystate(20, [10|Ics], Line, Tlen, _, _) ->
    yystate(28, Ics, Line+1, Tlen+1, 25, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(28, Ics, Line, Tlen+1, 25, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(28, Ics, Line, Tlen+1, 25, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(28, Ics, Line, Tlen+1, 25, Tlen);
...
yystate(12, Ics, Line, Tlen, _, _) ->
    {25,Tlen,Ics,Line,12};
yystate(11, [41|Ics], Line, Tlen, Action, Alen) ->
...
yystate(10, [79|Ics], Line, Tlen, _, _) ->
    yystate(6, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [45|Ics], Line, Tlen, _, _) ->
    yystate(5, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(5, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(5, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 80, C =< 90 ->
    yystate(5, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
...
yystate(3, [10|Ics], Line, Tlen, _, _) ->
    yystate(0, Ics, Line+1, Tlen+1, 25, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(0, Ics, Line, Tlen+1, 25, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 38 ->
    yystate(0, Ics, Line, Tlen+1, 25, Tlen);
yystate(3, [C|Ics], Line, Tlen, _, _) when C >= 40 ->
    yystate(0, Ics, Line, Tlen+1, 25, Tlen);
...
-file("src/floki_selector_lexer.xrl", 14).
yyaction_0(TokenChars, TokenLine) ->
...
-file("/usr/local/Cellar/erlang/23.0.3/lib/erlang/lib/parsetools-2.2/include/leexinc.hrl", 313).
